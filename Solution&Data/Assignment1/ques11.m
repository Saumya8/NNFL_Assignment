clc;
table1 = xlsread('D:\CMS\Sem3-1\Neural Networkand Fuzzy Logic\data4.xlsx');
...
%calculating mean
u1 = mean(t1(:,1:end-1))'; u2 = mean(t2(:,1:end-1))'; u3 = mean(t3(:,1:end-1))';
%calculating covariance matrix and determinant of covariance matrix
E1 = t1(:,1:end-1)'*t1(:,1:end-1); E1_det = det(E1);
E2 = t2(:,1:end-1)'*t2(:,1:end-1); E2_det = det(E2);
E3 = t3(:,1:end-1)'*t3(:,1:end-1); E3_det = det(E3);
